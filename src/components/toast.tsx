...
import { XMarkIcon, InformationCircleIcon, ExclamationCircleIcon } from '@heroicons/react/20/solid'
...
interface ToastContextType {
  addToast: (title: string, content: string, type: ToastType, duration?: number) => void
...
export const ToastProvider: FC<ToastProviderProps> = ({ children }) => {
  ...
  const addToast = useCallback(
    (title: string, content: string, type: ToastType, duration: number = 5000) => {
      ...
      setToasts((prevToasts) => [...prevToasts, { id, title, content, type, duration }])
