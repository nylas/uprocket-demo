              ...
              <CardHeader>
                <div className='flex items-center space-x-4'>
                  ...
                  <div className='ml-4'>
                    ...
                    <h5 className='text-sm text-gray-500'>{contractor.title}</h5>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <div className='flex items-center text-sm space-x-2 mb-2'>
                  <Badge className='bg-blue-100 text-blue-600' variant='secondary'>
                    {contractor.success_rate}% Job Success
                  </Badge>
                  <Badge className='bg-apple-100 text-apple-600' variant='secondary'>
                    Available Now
                  </Badge>
                </div>
