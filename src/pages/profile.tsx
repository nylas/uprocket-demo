...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    setSchedulingConfig({
      ...
      availability_open_hours:
        config?.availability?.participants?.[0]?.open_hours ?? [],
      ...
      event_title:
        ...
        ":duration minute consultation with :participant_names",
    });
  ...
  const onSubmit: FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    if (
      typeof schedulingConfig !== "undefined" &&
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                ...
                <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                          ...
                          <div className="flex h-6 items-center">
                            <input
                              ...
                              onChange={(e) =>
                                setProfile((p) => ({
                                  ...p,
                                  looking_for_work: e.target.checked,
                                }))
                              }
                            />
                          </div>
                  ...
                  <div className="col-span-full">
                    ...
                    <div className="text-sm leading-6">
                      <p className="text-gray-500">
                        Start typing to search for skills. Select up to 10
                        skills.
                      </p>
                    </div>
                    <div className="mt-2">
                          ...
                          <div className="flex">
                            ...
                            <div className="ml-3">
                              ...
                              <div className="mt-2 text-sm text-yellow-700">
                                <p>
                                  You need to log into connect your calendar
                                </p>
                              </div>
                              <div className="mt-2 text-sm text-yellow-700">
                                <NylasProvider
                        ...
                        <>
                          <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                              <select
                                ...
                                defaultValue={
                                  schedulingConfig.availability_calendar_ids
                                }
                                multiple={true}
                              >
                          ...
                          <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                              <NylasOpenHoursPicker
                                openHours={
                                  config?.availability?.participants?.[0]
                                    .open_hours ?? []
                                }
                  ...
                  {!isConfigLoading && !isLoadingCalendars && (
                    <div className="max-w-2xl space-y-10 md:col-span-2">
                      <div className="sm:col-span-3">
                        ...
                        <p className="text-gray-500">
                          Select the calendar you want your consultation
                          bookings to be added to.
                        </p>
                        <div className="mt-2">
                          <select
                      ...
                      <div className="col-span-full">
                        ...
                        <p className="mt-3 text-sm leading-6 text-gray-600">
                          Add a description for your consultation event. You can
                          use placeholders like <code>{":duration"}</code> and{" "}
                          <code>{":participant_names"}</code> to add the
                          duration and participant names to the description.
                        </p>
                      </div>
                    </div>
                  )}
